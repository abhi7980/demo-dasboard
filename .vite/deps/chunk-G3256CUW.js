...
function extendTheme(options = {}, ...args) {
  ...
  if (!defaultScheme) {
    throw new Error(true ? `MUI: The provided \`colorSchemes.${defaultColorScheme}\` to the \`extendTheme\` function is either missing or invalid.` : formatMuiErrorMessage(23, defaultColorScheme));
  }
...
//# sourceMappingURL=chunk-G3256CUW.js.map
